...
```
python3 ~/.claude/plugins/cache/fe-vibe/fe-google-tools/*/skills/google-docs/resources/markdown_to_gdocs.py --input /tmp/poc_doc.md --title "[External] [Customer]-Databricks POC DOC"
```
