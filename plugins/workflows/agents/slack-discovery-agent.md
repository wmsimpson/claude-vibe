...
To enable Slack access, configure the Slack MCP server in your `mcp-servers.yaml` or Claude Code MCP settings. Refer to `plugins/mcp-servers/` for MCP server setup instructions.
