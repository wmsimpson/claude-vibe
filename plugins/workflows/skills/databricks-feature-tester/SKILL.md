---
name: databricks-feature-tester
...
**Announce at start:** "I'm using the databricks-feature-tester skill to test Databricks features."
...
```
Task tool with subagent_type='workflows:product-question-researcher' and model='opus'
...
```
Task tool with subagent_type='workflows:databricks-feature-test-executor' and model='opus'
Prompt: |
...
- `workflows/agents/databricks-feature-test-executor.md` - Test execution agent
- `databricks-tools/skills/databricks-oneenv-workspace-deployment/resources/` - One-Env helpers
- `databricks-tools/skills/databricks-fe-vm-workspace-deployment/resources/` - FE-VM helpers
