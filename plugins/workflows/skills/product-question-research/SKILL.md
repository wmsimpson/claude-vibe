...
- `google-tools/skills/google-docs/resources/gdocs_builder.py` - Helper for creating properly formatted Google Docs (supports `add-bullets`, `add-link`, `add-links-by-text`)
