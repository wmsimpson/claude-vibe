...
**Announce at start:** "I'm using the rfp skill to answer RFP questions using the RFP Response Assistant."
...
GSHEETS_CLI=~/.claude/plugins/cache/claude-vibe/google-tools/*/skills/google-sheets/resources/gsheets_cli.sh
