...
# Re-install all
for p in fe-app-dev fe-databricks-tools fe-google-tools fe-specialized-agents fe-vibe-setup fe-jira-tools fe-workflows lean-sigma-tools fe-macos-scheduler; do
